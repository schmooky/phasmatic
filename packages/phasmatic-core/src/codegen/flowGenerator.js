 ...
 */
export async function generateGameFlow(definition, options) {
 ...
 */
function generatePhaseEnum(definition, outputDir) {
 ...
 */
function generateContextType(definition, outputDir, options) {
 ...
 */
function generatePhaseFiles(definition, phasesDir, options) {
 ...
 */
function generatePhaseFunction(definition, phase, options) {
 ...
 */
function generateStateMachineWithImports(definition, outputDir, options) {
    const content = `// This file is auto-generated. Do not edit manually.
 ...
 * Generates the state machine file with all phases in one file
 */
function generateStateMachineSingleFile(definition, outputDir, options) {
    const content = `// This file is auto-generated. Do not edit manually.
import { StateMachine, Phase, PhaseContext } from 'phasmatic';
import { ${definition.phaseEnumName} } from './phases';
import { ${definition.contextTypeName} } from './context';
