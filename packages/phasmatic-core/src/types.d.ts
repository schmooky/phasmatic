 ...
 */
export type PhaseHandler<TContext, TReturn> = (context: PhaseContext<TContext>) => TReturn | Promise<TReturn>;
/**
 ...
 */
export declare const PHASE_REGISTRY: unique symbol;
/**
 * Error types specific to Phasmatic
 */
export declare enum PhasmaticErrorType {
